...
func NewUnbindPacketConn(conn net.Conn) N.NetPacketConn {
	return &UnbindPacketConn{
		...
		M.ParseSocksAddrFromNet(conn.RemoteAddr()),
	}
}
...
func (c *UnbindPacketConn) ReadPacket(buffer *pool.Buffer) (destination M.Socksaddr, err error) {
...
func (c *UnbindPacketConn) WritePacket(buffer *pool.Buffer, _ M.Socksaddr) error {
