...
func (w *syscallReadWaiter) WaitReadBuffer() (buffer *pool.Buffer, err error) {
	if w.readFunc == nil {
...
func (w *syscallPacketReadWaiter) WaitReadPacket() (buffer *pool.Buffer, destination M.Socksaddr, err error) {
	if w.readFunc == nil {
