...
func (c *TimerPacketConn) ReadPacket(buffer *pool.Buffer) (destination M.Socksaddr, err error) {
...
func (c *TimerPacketConn) WritePacket(buffer *pool.Buffer, destination M.Socksaddr) error {
