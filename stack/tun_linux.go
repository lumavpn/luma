...
func (t *NativeTun) BatchSize() int {
	...
	/* // Not works on some devices: https://github.com/lumavpn/luma-box/issues/1605
...
func (t *NativeTun) Close() error {
	...
	return E.Errors(t.unsetRoute(), t.unsetRules(), util.Close(util.PtrOrNil(t.tunFile)))
}
...
func (t *NativeTun) routes(tunLink netlink.Link) ([]netlink.Route, error) {
	...
	return util.Map(routeRanges, func(it netip.Prefix) netlink.Route {
...
func (t *NativeTun) routeUpdate(event int) {
	if event&monitor.EventAndroidVPNUpdate == 0 {
		return
	}
	err := t.resetRules()
	if err != nil {
		log.Error(E.Cause(err, "reset route"))
	}
}
