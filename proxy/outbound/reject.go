...
func (r *Reject) DialContext(ctx context.Context, metadata *M.Metadata, opts ...dialer.Option) (P.Conn, error) {
	if r.drop {
...
func (r *Reject) ListenPacketContext(ctx context.Context, metadata *M.Metadata, opts ...dialer.Option) (P.PacketConn, error) {
