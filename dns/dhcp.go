...
import (
	...
	"github.com/lumavpn/luma/component/dhcp"
	...
	if err != nil {
		...
		go func() {
			...
			if err == nil {
				...
				res = transform(nameserver, d.proxyDialer, nil)
			}
...
func newDHCPClient(ifaceName string, proxyDialer proxydialer.ProxyDialer) *dhcpClient {
	return &dhcpClient{ifaceName: ifaceName, proxyDialer: proxyDialer}
}
