...
func GetRealityConn(ctx context.Context, conn net.Conn, ClientFingerprint string, tlsConfig *tls.Config, realityConfig *RealityConfig) (net.Conn, error) {
	...
	for fingerprint, exists := GetFingerprint(ClientFingerprint); exists; retry++ {
		...
		log.Debugf("REALITY Authentication: %v, AEAD: %T", verifier.verified, aeadCipher)
...
var pOffset = util.MustOK(reflect.TypeOf((*utls.Conn)(nil)).Elem().FieldByName("peerCertificates")).Offset
