...
var _ conn.EnhancePacketConn = (*EnhancePacketConn)(nil)

func NewEnhancePacketConn(pc conn.EnhancePacketConn) conn.EnhancePacketConn {
	return NewNetPacketConn(pc).(conn.EnhancePacketConn)
}
...
type enhancePacketConn struct {
	...
	enhancePacketConn conn.EnhancePacketConn
}
